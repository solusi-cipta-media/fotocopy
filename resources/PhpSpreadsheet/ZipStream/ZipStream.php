...
require('./resources/PhpSpreadsheet/ZipStream/Bigint.php');
require('./resources/PhpSpreadsheet/ZipStream/Option/File.php');
require('./resources/PhpSpreadsheet/ZipStream/File.php');
