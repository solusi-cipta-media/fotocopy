...
<head>
    ...
    <link rel="shortcut icon" href="assets/media/favicons/cms.png">
    <link rel="icon" type="image/png" sizes="192x192" href="assets/media/favicons/cms.png">
    <link rel="apple-touch-icon" sizes="180x180" href="assets/media/favicons/cms.png">
                ...
                <div class="row mx-0 bg-black-50">
                    ...
                    <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-body-extra-light">
                        <div class="content content-full">
                            ...
                            <form class="js-validation-signin px-4" action="<?= base_url('design/dashboard') ?>" method="POST">
                                ...
                                <div class="mb-4">
                                    <a href="<?= base_url('design/dashboard') ?>" type="button" class="btn btn-lg btn-alt-primary fw-semibold">
                                        Sign In
                                    </a>
                                    <!-- <div class="mt-4">
